...
```{r, message=FALSE}
pdf(file="../figures/WL.PCoA_Env.pdf",
    width = 4.5, height = 9)
...
# Initiate Plot
plot(cent.dataframe[,1], cent.dataframe[,2], type = 'n', las = 1,
     xlim = c(-0.8, 0.85), ylim = c(-0.8, 0.8),
     xaxt = "n", xlab = "", yaxt = "n", ylab="")
...
par(lwd = 2)
plot(fit, p.max = 0.008, labels = c("Moisture", "Temp", "pH", "TOC", "OM", expression("NH"[4]), expression("NO"[3])), cex = 1.5)
par(lwd = 1)
...
par(lwd = 2)
#plot(fit, p.max = 0.01)
plot(fit, p.max = 0.01, labels = c("Moisture", "Temp", "pH", "OM", expression("NH"[4]), expression("NO"[3])), cex = 1.5)
par(lwd = 1)
...
```{r}
pdf(file="../figures/reed.biomass.pdf",
    width = 5, height = 4)
