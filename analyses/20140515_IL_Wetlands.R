...
require(vegan)                    # What are all of these for? #
#require(permute)                 ##############################
require(reshape)
#require(labdsv)
...
new.data <- read.csv("WLbact_STD.csv", header=TRUE)
...
# Call:
# adonis(formula = new.data[, -c(1:6)] ~ Treatment, data = new.data,      permutations = 1000, method = "bray") 

# Terms added sequentially (first to last)

          # Df SumsOfSqs   MeanSqs F.Model      R2  Pr(>F)  
# Treatment  5   0.08512 0.0170241  1.8698 0.10015 0.01099 *
# Residuals 84   0.76479 0.0091046         0.89985          
# Total     89   0.84991                   1.00000          
# ---
